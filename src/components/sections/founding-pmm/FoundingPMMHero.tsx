...
export function FoundingPMMHero() {
    return (
                ...
                <div className="space-y-8">
                    ...
                    <div className="space-y-2">
                        <h1 className="text-3xl md:text-4xl text-zinc-900 leading-[1.1]">
                            ...
                            <br />
                            <span className=" text-zinc-500">But you don't have to work alone.</span>
                        </h1>
                    </div>

                    <p className="text-lg text-zinc-500 leading-relaxed max-w-lg">
                        As a founding PMM, you're expected to hold the whole company story together. Oden gives you one operating system for signal, authored truth, and current outputs.
                    </p>
